...
namespace MLHomeworkML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Projects\csharp-web\ASP.NET-Core-MVC\Resources\carsbg.csv";
        private static string MODEL_FILEPATH = @"../../../../MLHomeworkML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options() { NumberOfLeaves = 105, MinimumExampleCountPerLeaf = 10, NumberOfTrees = 500, LearningRate = 0.3907486f, Shrinkage = 1.450561f, LabelColumnName = "Price", FeatureColumnName = "Features" });
