...
namespace Eventures.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^[\w-_.*~]*$", ErrorMessage ="{0} can contain only letters, numbers and _ - * . ~")]
            ...
            [Required]
            [StringLength(10, ErrorMessage ="The {0} should be exactly {1} characters long!", MinimumLength = 10)]
            [Display(Name = "UCN")]
