...
namespace Rider.Data.Migrations
{
    ...
    [Migration("20190820072118_TrackEntityUpdateIsActiveAndIsArchivedAdded")]
    partial class TrackEntityUpdateIsActiveAndIsArchivedAdded
    {
            ...
            modelBuilder.Entity("Rider.Domain.Models.BikeParts", b =>
                {
                    ...
                    b.Property<int>("PlayerPartId");

                    b.HasKey("Id");

                    b.HasIndex("BikeId");

                    b.HasIndex("PlayerPartId");
            ...
            modelBuilder.Entity("Rider.Domain.Models.BikeParts", b =>
                {
                    ...
                    b.HasOne("Rider.Domain.Models.PlayerParts", "PlayerPart")
                        .WithMany()
                        .HasForeignKey("PlayerPartId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Rider.Domain.Models.PlayerParts", b =>
                {
                    b.HasOne("Rider.Domain.Models.BikeParts", "BikePart")
                        .WithMany()
