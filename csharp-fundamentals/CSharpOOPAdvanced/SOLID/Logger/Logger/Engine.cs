using Logger.Architecture;
using Logger.Architecture.Appenders;
using Logger.Architecture.Interfaces;
using Logger.Architecture.Layouts;
using Logger.Architecture.Loggers;
using System;
...
namespace Logger
{
    public class Engine
    {
        public void Run(int appenderCount)
        {
            ...
            var logger = new SimpleLogger(appenders);
